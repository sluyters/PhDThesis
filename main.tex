\pdfmapline{-dummy Arial}
\pdfmapline{-dummy Arial,Bold}
...
% \colorlet{highlightcolor}{graybluebrighter} % Print
% \colorlet{inlinecodecolor}{customlightgray} % Print
% \colorlet{circlecolor1}{black} % Print
% \colorlet{circlecolor2}{customgray} % Print
\colorlet{highlightcolor}{graybluebrighter} % Web
\colorlet{inlinecodecolor}{graybluebrighterer} % Web
...
\fancyhead[LE,RO]{\textsl{\leftmark}}%Bibliography}}
...
% \fancyhead[LO,RE]{}%\slshape Bibliography}
% \fancyhead[LE,RO]{\textsl{APPENDIX}}%Bibliography}}
\appendix
% \fancyhead{} % Clear headers
% \fancyhead[LO,RE]{\textsl{\rightmark}}
% \fancyhead[LE,RO]{\textsl{\leftmark}}
