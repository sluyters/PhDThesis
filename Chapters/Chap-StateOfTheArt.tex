...
\textbf{TODO - Discuss DTW for segmentation and link to dynamic recognition (here and/or in future works?)}
...
\subsubsection{Gorilla arm effect} \label{sec:state_of_the_art:overview:challenges:gorilla-arm}
\textbf{TODO}
cite "Consumed Endurance: A Metric to Quantify Arm Fatigue of Mid-Air Interactions", say how the compute the metric

\subsubsection{Gesture discoverability and affordance} \label{sec:state_of_the_art:overview:challenges:gorilla-arm}
\textbf{TODO}

\subsubsection{Communicating user errors} \label{sec:state_of_the_art:overview:challenges:TODO}
\textbf{TODO}
