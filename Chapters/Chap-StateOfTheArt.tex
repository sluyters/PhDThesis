...
Then, care should be given to design customization UI that is usable by everyone, in particular, people with a disability who may not be happy with the pre-designed gestures. This UI should ideally integrate seamlessly into a gesture-based application.
%
...
Finally, how to represent gestures to users? Rather trivial with 2D gestures, Ok with 3d gestures, but what about radars and other sensors? \textbf{TODO}
