...
https://dl.acm.org/doi/10.1145/2807442.2807489 \textbf{TODO Gunslinger}
...
% Possible solutions
Bau and Mackay~\cite{Bau:2008}, and Kristensson and Denby~\cite{Kristensson:2011} looked into teaching 2D gestures by recognizing incomplete trajectories drawn by the users and suggesting possible continuations by displaying them on the screen.
%
Rovelo \etal~\cite{Rovelo:2015} later applied the same strategy to mid-air gesture interaction. After comparing their implementation with a printed guide of gestures, they observed that \textbf{TODO} + Octopipe ou Octopocus 3D? Laurence Nigay
%
ShapelineGuide~\cite{Alt:2018} 3D \textbf{TODO}
%
Other stretegies for introducing 3D gestures have been studied and compared in the literature.
%
White \etal~\cite{White:2007} compared text, diagram, and ghosting to show how to interact with objects in AR.%3D, compare different methods for showing how to interact with objects in AR (text, diagram, and ghosting)
%
Walter \etal~\cite{Walter:2013} investigated three strategies to reveal an initial gesture on interactive public displays: spatial division (an explanation of the gesture is displayed on part of the screen), temporal division (the application is interrupted to reveal the gesture in full screen), and integration (visual cues are integrated in the application). Spatial division worked well while temporal division triggered users to leave while the cue was shown, as it interrupted their interaction with the application. \textbf{TODO make shorter}
...
Template mùatching intrinsically supports customization. Some deeplearning can support that without complete retraining, but issues (catastrophic forgetting -> désapprendre des trucs pour apprendre ce qu'on lui ajoute) https://www.researchgate.net/publication/335698970_A_Study_on_Catastrophic_Forgetting_in_Deep_LSTM_Networks
%
